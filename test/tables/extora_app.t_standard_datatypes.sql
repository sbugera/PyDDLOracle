...
(
  C_VARCHAR2                          VARCHAR2(10 BYTE) DEFAULT null,
  ...
  C_VARCHAR2_COLLATION                VARCHAR2(18 BYTE) COLLATE USING_NLS_SORT_AI,
  ...
  C_DEC_PRECISION_SCALE               NUMBER(20,3),
...
LOB (C_CLOB_STORAGE) STORE AS SECUREFILE C_CLOB_STORAGE_SEGMENT (
  ...
  NOCACHE
  LOGGING)
LOB (C_JSON) STORE AS SECUREFILE (
  TABLESPACE  EXTORA_APP_DATA
  ENABLE      STORAGE IN ROW
  CHUNK       8192
  RETENTION
