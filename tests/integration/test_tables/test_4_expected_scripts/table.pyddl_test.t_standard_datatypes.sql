...
prompt Constraints for table pyddl_test.t_standard_datatypes
alter table pyddl_test.t_standard_datatypes add (
  constraint pk_t_standard_datatypes
  primary key (c_varchar2, c_number)
  using index pyddl_test.pk_t_standard_datatypes
  enable validate,
  constraint "T_STANDARD_DATATYPES_uk_02"
  unique ("c_Camel_Case_Name       32 Chars")
  using index pyddl_test."T_STANDARD_DATATYPES_uk_02"
  enable validate,
  constraint uk_t_standard_datatypes
  unique (c_char, c_number)
  using index pyddl_test.uk_t_standard_datatypes
  enable validate);
