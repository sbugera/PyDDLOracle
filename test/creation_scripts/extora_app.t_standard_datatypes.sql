...
(
  ...
  c_varchar2_collation               VARCHAR2(18) COLLATE USING_NLS_SORT_AI DEFAULT 'abc' NOT NULL,
  ...
  c_dec_precision_scale              DEC(20,3) NOT NULL,
  ...
  c_json                             JSON,
  "c_Camel_Case_Name       32 Chars" VARCHAR2(100)
)
